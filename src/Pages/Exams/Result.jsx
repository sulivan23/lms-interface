...
import { getResultExam, getResultExamByEmployee } from "../../api/Exams";
...
class ResultExams extends Component { 
    ...
    async getResult() {
        ...
        const result = await getResultExam(param);
                ...
                <section className="section">
                    <div className="section-header">
                        ...
                        <div className="section-header-breadcrumb">
                            ...
                            <div className="breadcrumb-item">Result Exams</div>
                        </div>
                    </div>
                                                        ...
                                                        this.state.resultData.map((result, i) => {
                                                            return (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td>{result.score}</td>
                                                                    <td>{result.passed_status}</td>
                                                                    <td>{result.exam.passing_grade}</td>
                                                                    ...
                                                                    <td>
                                                                        {
                                                                            result.status == 'Done' ?
                                                                                <Link class="btn btn-primary my-2 mb-2 w-100" to={`/home/exam_answer/${result.exam.id}/1/result`}>Detail</Link>
                                                                            :
                                                                            ''
                                                                        }
                                                                    </td>
